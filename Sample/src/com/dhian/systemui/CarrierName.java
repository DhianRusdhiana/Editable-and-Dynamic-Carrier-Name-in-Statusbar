...
extends TextView {
    ...
    public CarrierName(Context context) {
        super(context);
		...
		if(!getBooleanFromkey("defaultfont",context)){
		sp = PreferenceManager.getDefaultSharedPreferences(getContext());
		font = sp.getString("carrier_name_font", "fonts/DroidSans.ttf");
	...
	if(!getBooleanFromkey("defaultcolor",context)){
		this.setTextColor(getIntFromkey(context,"carrier_name_color"));

	}else{
		this.setTextColor(Color.WHITE);
	}
	if(!getBooleanFromkey("defaultsize",context)){
		this.setTextSize(getFloatFromkey(context,"carrier_name_size"));
	}else{
		this.setTextSize(16);
	}
	...
	sp = PreferenceManager.getDefaultSharedPreferences(getContext());
		...
		builder.append(sp.getString("set_carrier_name", "Carrier Name"));
    ...
    public CarrierName(Context context, AttributeSet attributeSet) {
    ...
    public CarrierName(Context context, AttributeSet attributeSet, int n) {
